...
% subplot(5,1,1); plot(QNt_generated{1,1}.t, QNt_generated{1,1}.metric)
% hold on 
...
% xlabel('Time (s)')
% legend('G. Net.', 'P. Net')
% subplot(5,1,2); plot(QNt_generated{2,1}.t, QNt_generated{2,1}.metric)
% hold on 
...
% ylabel('Av. Q. Len.')
% xlabel('Time (s)')
% subplot(5,1,3); plot(QNt_generated{3,1}.t, QNt_generated{3,1}.metric)
% hold on 
...
% ylabel('Av. Q. Len.')
% xlabel('Time (s)')
% subplot(5,1,4); plot(QNt_generated{4,1}.t, QNt_generated{4,1}.metric)
% hold on 
% plot(QNt_predicted{4,1}.t, QNt_predicted{4,1}.metric, 'r')
% hold off
% title('Station 4')
% ylabel('Av. Q. Len.')
% xlabel('Time (s)')
% subplot(5,1,5); plot(QNt_generated{5,1}.t, QNt_generated{5,1}.metric)
% hold on 
% plot(QNt_predicted{5,1}.t, QNt_predicted{5,1}.metric, 'r')
% hold off
% title('Station 4')
% ylabel('Av. Q. Len.')
% xlabel('Time (s)')
...
% subplot(5,1,1); plot(UNt_generated{1,1}.t, UNt_generated{1,1}.metric)
% hold on 
...
% xlabel('Time (s)')
% legend('G. Net.', 'P. Net.')
% subplot(5,1,2); plot(UNt_generated{2,1}.t, UNt_generated{2,1}.metric)
% hold on 
...
% ylabel('Utilization')
% xlabel('Time (s)')
% subplot(5,1,3); plot(UNt_generated{3,1}.t, UNt_generated{3,1}.metric)
% hold on 
...
% ylabel('Utilization')
% xlabel('Time (s)')
% subplot(5,1,4); plot(UNt_generated{4,1}.t, UNt_generated{4,1}.metric)
% hold on 
% plot(UNt_predicted{4,1}.t, UNt_predicted{4,1}.metric)
% hold off
% title('Station 4')
% ylabel('Utilization')
% xlabel('Time (s)')
% subplot(5,1,5); plot(UNt_generated{5,1}.t, UNt_generated{5,1}.metric)
% hold on 
% plot(UNt_predicted{5,1}.t, UNt_predicted{5,1}.metric)
% hold off
% title('Station 5')
% ylabel('Utilization')
% xlabel('Time (s)')
